...
export function ImageGenerationForm({
    ...
    function getRandomPrompt(): string {
        return sample(examplePopularPrompts) ?? examplePopularPrompts[0];
    }
...
const _examplePrompts = [
    "Intricate and vibrant psychedelic mandala with neon pink, electric blue, and bright yellow, featuring swirling fractal designs and geometric patterns",
    "Vintage 80s retro wave sunset with neon-colored palm trees, a glowing grid-patterned ground, and a radiant sun setting over a serene ocean horizon",
    "Adorable cartoon animals playing musical instruments in a lively outdoor concert, featuring a bear on drums, a rabbit with a guitar, and a fox with a saxophone",
    ...
    "Bold and dynamic abstract watercolor splashes with bright colors, blending seamlessly with soft gradients and gold accents",
    "Inspirational quote in elegant calligraphy, surrounded by delicate roses and vines in pastel colors, with a soft watercolor background",
    "Stylized Japanese wave pattern with traditional Hokusai-style details, koi fish swimming, and cherry blossoms floating on the water",
    "Steampunk mechanical heart with intricate gears and cogs, metallic textures, a vintage bronze color palette, and steam effects",
    "Minimalist line art of mountain ranges and forests, with clean lines, subtle shading in monochrome, and a rising sun in the background",
    ...
    "Dynamic anime character in an action pose with a glowing sword, wearing futuristic armor and set against a vibrant neon cityscape at night",
    "Pixel art of a bustling cityscape at night with detailed neon signs, tiny animated characters walking along the streets, and moving vehicles",
    "Photograph of a roaring lion with a dramatic background, capturing the intensity and power of the animal in its natural savannah habitat",
    "Cute anime-style cat with a bowtie and glasses, sitting in a playful pose with sparkling eyes and a pastel-colored, whimsical background",
    "Retro pixel art of a classic arcade game screen, featuring pixelated characters, obstacles, a high score counter, and vibrant colors",
    ...
    "Watercolor painting of a serene beach with palm trees, gentle waves, a clear blue sky, soft sand, and a distant sailboat",
    ...
    "Pixel art of a fantasy RPG character with a sword and shield, standing in a detailed medieval village with lush environment",
    "Photograph of a majestic eagle soaring in the sky, capturing the bird in mid-flight with its wings spread wide against a dramatic sky",
    "Illustration of a jazz band with lively musicians playing a saxophone, trumpet, and piano, set in a colorful, dynamic scene with musical notes swirling around",
    "Pixel art of a cozy café with detailed tables, chairs, and a barista behind the counter, featuring people sipping coffee and a warm ambiance",
...
const examplePopularPrompts = [
    "Retro arcade scene with neon colors, featuring pixelated characters and geometric patterns.",
    "Abstract geometric shapes in vibrant colors, forming a modern, eye-catching design.",
    "Vintage floral pattern with peace symbols, using earthy tones and psychedelic swirls.",
    "Minimalist mountain landscape at sunset with clean lines and a pastel color palette.",
    "Surreal underwater world with fantastical sea creatures and coral reefs in vivid colors.",
    "Bold typography design with a motivational quote, using contrasting fonts and colors.",
    "Cyberpunk cityscape at night, with neon lights and futuristic buildings.",
    "Anime-style original character with detailed costume and dynamic pose, set against a vibrant background.",
    "Retro pop culture-inspired collage, featuring music and TV references from the past.",
    "Pixel art fantasy scene with knights and mythical creatures in a pixelated medieval setting.",
    "Steampunk-inspired mechanical octopus with gears and cogs, in a sepia tone.",
    "Photorealistic tiger in mid-roar, with detailed fur and intense eyes.",
    "Abstract art inspired by nature, with leaves and flowers in bold, abstract forms.",
    "Vintage racing scene, with classic cars and retro typography.",
    "Cute cartoon animals in a whimsical forest setting, using bright, cheerful colors.",
    "Detailed guitar illustration with musical notes and a grunge texture background.",
    "Fantasy dragon flying over a castle, with detailed scales and fiery breath.",
    "Y2K-inspired design with metallic elements, bright neon colors, and early 2000s motifs.",
    "Photorealistic wolf howling at the moon, with detailed fur and night sky.",
    "Retro sci-fi robot with a vintage design, set against a futuristic cityscape.",
    "Elegant peacock with fully spread feathers, in a detailed, vibrant illustration.",
    "Graffiti-style street art design with bold colors and urban elements.",
    "Cute anime chibi characters in a playful, dynamic scene.",
    "Pixel art beach scene with a sunset and pixelated palm trees.",
    "Bold abstract painting with bright, contrasting colors and dynamic brushstrokes.",
