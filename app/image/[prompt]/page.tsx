...
export const generateImageUrl: (prompt: string) => Promise<string> = async (prompt: string) => {
    try {
...
export async function createProduct({ blueprint_id, description, print_areas, print_provider_id, title, variants}: PrintifyProductRequest ) {
...
export function constructProductRequest(image_id: string) {
    const productRequest: PrintifyProductRequest = {
